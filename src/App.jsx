...
import { Stake, ChooseBond, Bond, TreasuryDashboard, Presale, Claim } from "./views";
...
import "./style.scss";
import { guita_dai } from "./helpers/AllBonds";
...
function App() {
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSafetyCheck()) {
      dispatch(info("Safety Check: Always verify you're on guitadao.com!"));
    }
  }, []);
