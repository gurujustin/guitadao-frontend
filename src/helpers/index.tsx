...
import { ReactComponent as GuitaImg } from "../assets/tokens/GUITA.svg";
import { ReactComponent as SGuitaImg } from "../assets/tokens/SGUITA.svg";

import { guita_dai } from "./AllBonds";
...
export async function getMarketPrice({ networkID, provider }: IBaseAsyncThunk) {
  const guita_dai_address = guita_dai.getAddressForReserve(networkID);
  const pairContract = new ethers.Contract(guita_dai_address, PairContract, provider);
...
export async function getTokenPrice(tokenId = "guita-dao") {
