...
import { ReactComponent as GuitaIcon } from "../../assets/icons/guita-nav-header.svg";
      ...
      <Box className="dapp-sidebar-inner" display="flex" justifyContent="space-between" flexDirection="column">
        <div className="dapp-menu-top">
          <Box className="branding-header">
            <Link href="https://guitadao.com" target="_blank">
              <SvgIcon
                color="primary"
                component={GuitaIcon}
                viewBox="0 0 151 100"
              ...
              />
              <div className="wallet-link f-32">GuitaDAO</div>
            </Link>
            {address && (
