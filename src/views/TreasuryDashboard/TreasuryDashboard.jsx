...
function TreasuryDashboard() {
  ...
  const backingPerGuita = useSelector(state => {
  ...
  const wsGuitaPrice = useSelector(state => {
            ...
            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center">
              ...
              <Box className="metric wsoprice">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "wsGUITA = sGUITA * index\n\nThe price of wsGUITA is equal to the price of GUITA multiplied by the current index"
                    }
                  />
                </Typography>

                <Typography variant="h5">
                  {wsGuitaPrice ? formatCurrency(wsGuitaPrice, 2) : <Skeleton type="text" />}
                </Typography>
              </Box>
              ...
              <Box className="metric bpo">
                ...
                <Typography variant="h5">
                  {backingPerGuita ? formatCurrency(backingPerGuita, 2) : <Skeleton type="text" />}
                </Typography>
              </Box>
              ...
              <Box className="metric index">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "The current index tracks the amount of sGUITA accumulated since the beginning of staking. Basically, how much sGUITA one would have if they staked and held a single GUITA from day 1."
                    }
                  />
                </Typography>
                <Typography variant="h5">
                  {currentIndex ? trim(currentIndex, 2) + " sGUITA" : <Skeleton type="text" />}
                </Typography>
              </Box>
            </Box>
          </Paper>
